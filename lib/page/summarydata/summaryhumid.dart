...
class SummaryHumid extends StatefulWidget {
  const SummaryHumid({super.key});

  @override
  State<SummaryHumid> createState() => _SummaryHumidState();
}

class _SummaryHumidState extends State<SummaryHumid> {
  List<_AVGData> data = [
    _AVGData('10AM', 35),
    _AVGData('11AM', 28),
    _AVGData('12AM', 34),
