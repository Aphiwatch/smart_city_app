...
class SummaryTemp extends StatefulWidget {
  const SummaryTemp({super.key});

  @override
  State<SummaryTemp> createState() => _SummaryTempState();
}

class _SummaryTempState extends State<SummaryTemp> {
  List<_AVGData> data = [
    _AVGData('10AM', 35),
    _AVGData('11AM', 28),
    _AVGData('12AM', 34),
